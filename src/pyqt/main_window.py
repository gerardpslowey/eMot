...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(10, 10, 1061, 651))
...
"border: 1px solid black;")
        ...
        self.emotHeader2_2 = QtWidgets.QLabel(self.reportsPage)
        self.emotHeader2_2.setGeometry(QtCore.QRect(390, 50, 279, 81))
        font = QtGui.QFont()
        font.setPointSize(40)
        font.setBold(False)
        font.setWeight(50)
        self.emotHeader2_2.setFont(font)
        self.emotHeader2_2.setAlignment(QtCore.Qt.AlignCenter)
        self.emotHeader2_2.setObjectName("emotHeader2_2")
        self.scrollArea = QtWidgets.QScrollArea(self.reportsPage)
        self.scrollArea.setGeometry(QtCore.QRect(10, 170, 1041, 471))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1039, 469))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.scrollAreaWidgetContents)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(-1, -1, 1041, 471))
...
"selection-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.emotHeader2_2.setText(_translate("MainWindow", "eMot"))
