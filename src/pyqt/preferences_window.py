...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.blacklistInfo.setText(_translate("Form", "The blacklists contain items that are excluded from searches. \n"
"Add a URL so that it is not gathered from your browsing history. \n"
"Or add a HTML tag so that it is not scraped!"))
