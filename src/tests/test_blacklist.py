...
def test_blacklist_checker():
    history_list = ['https://www.dcu.ie/', 'https://opentimetable.dcu.ie/',
                    'https://gitlab.computing.dcu.ie/', 'https://github.com/notifications',
                    'https://www.facebook.com/help', 'https://stackoverflow.com/users/']
    blacklist = ['www.facebook.com', 'www.mail.google.com','www.twitter.com', 'https://discord.com', 'https://www.reddit.com/']  # noqa

    expected_filters = ['https://www.dcu.ie/', 'https://opentimetable.dcu.ie/',
                        'https://gitlab.computing.dcu.ie/', 'https://github.com/notifications',
