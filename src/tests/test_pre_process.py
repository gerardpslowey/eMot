...
from utils.textMod import preProcess, removeURLs, removeRepetitions, spellCheck
# from utils.textMod import preprocessAndTokenise
...
#     "I should be sleep, but im not! thinking about an old friend who I want."
#     + " but he's married now. damn, &amp; he wants me 2! scandalous!",
...
#     "@BrodyJenner if u watch the hills in london u will realise what"
#     + " tourture it is because were weeks and weeks late  i just watch itonlinelol",
#     "Got the news",
...
#     "How are YOU convinced that I have always wanted you?
#      + " What signals did I give off...damn I think I just lost another friend",
#     "@raaaaaaek oh too bad! I hope it gets better. I've been having sleep issues lately too",
#     "Wondering why I'm awake at 7am,writing a new song,plotting my evil
#      + " secret plots muahahaha...oh damn it,not secret anymore",
#     "No Topic Maps talks at the Balisage Markup Conference 2009   Program
#     + " at http://tr.im/mL6Z (via @bobdc) #topicmaps",
...
#     "On my way home n having 2 deal w underage girls drinking
#     + " gin on da bus while talking bout keggers......damn i feel old",
#     "@IsaacMascote  i'm sorry people are so rude to you, isaac, they should
#     + " get some manners and know better than to be so lewd!",
...
#     "@ether_radio yeah :S i feel all funny cause i haven't slept enough  i
#     + " woke my mum up cause i was singing she's not impressed :S you?",
